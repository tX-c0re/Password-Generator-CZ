...
class data_plus:
	# používat n-tice místo seznamů, protože je to rychlejší a efektivnější.
	# a generátory jsou ještě efektivnější (malé využití paměti, výkon...)
...
class dates_perm:
	# Vzhledem k tomu, že formát data je dd-mm-yyyy, jak to zname v ČR
...
class phones_perm:
	def __init__(self, phones):
		# Formát telefonu: (+Předčíslí)xxxxxxxxxx
